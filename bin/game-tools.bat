...
SET BITS=64
SET USER_JDK64_FILE=%APPDATA%\Google\AndroidGameDevelopmentTools\studio%BITS%.exe.jdk
SET BITS=
SET USER_JDK_FILE=%APPDATA%\Google\AndroidGameDevelopmentTools\studio%BITS%.exe.jdk
...
SET COMMON_JVM_ARGS="-XX:ErrorFile=%USERPROFILE%\java_error_in_@@base_name@@_%%p.log" "-XX:HeapDumpPath=%USERPROFILE%\java_error_in_@@base_name@@.hprof" -Didea.vendor.name=Google -Didea.paths.selector=AndroidGameDevelopmentTools %IDE_PROPERTIES_PROPERTY%
SET IDE_JVM_ARGS=-Didea.platform.prefix=AndroidStudio -Didea.jre.check=true -Didea.platform.prefix=AndroidGameDevelopmentTools -Didea.load.plugins=false -Didea.initially.ask.config=force-not
